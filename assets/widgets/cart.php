...
<ul class="cart-container-list">
                ...
                foreach ($_SESSION["cart"] as $cartobj){ //cartobj: [productid, count, colorid]
                    ...
                    <li>
                        <div class="cart-product-container">
                            <button class="cart-product-removeBtn">
                            ...
                            <div class="cart-data-img-container">
                                ...
                                <div class="cart-product-data-container">
                                    ...
                                    <div class="cart-color-container">
                                        <div class="product-color-coloritem cart-color-coloritem" style="background-color: rgb(255, 0, 255);"></div>
                                        <div class="product-color-coloritem cart-color-coloritem" style="background-color: rgb(255, 255, 255);"></div>
                                    </div>
                                    <div class="cart-amount-container">
                                        <button class="cart-changeAmount-minus">
    ...
    <?php
        $endprice /= round(count($_SESSION["cart"]), 2);
    ?>
