...
<link rel="icon" type="image/x-icon" href="<?php echo $rootpath ?>/assets/img/logo.ico">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<script src="https://use.fontawesome.com/releases/v6.1.0/js/all.js" data-auto-replace-svg></script>